...
public class TemplateLoaderJob implements IRunnableWithProgress {

	BundleContext bundleContext = FrameworkUtil.getBundle(TemplateLoaderJob.class).getBundleContext();

	private final String[] templateTypes;
	
	public TemplateLoaderJob(String[] templateTypes) {
		this.templateTypes = templateTypes;
	}
	
	Set<Template> getTemplates(String templateType, IProgressMonitor progress) throws InvocationTargetException {
	...
	private Map<String, Set<Template>> templates = new HashMap<String,Set<Template>>();
